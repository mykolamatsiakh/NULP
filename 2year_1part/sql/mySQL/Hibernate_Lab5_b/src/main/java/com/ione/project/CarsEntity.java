...
public class CarsEntity {
    ...
    private Collection<AvtosalonEntity> id;

    @OneToMany(mappedBy = "id")
    public Collection<AvtosalonEntity> getId() {
        return id;
    }

    public void setId(Collection<AvtosalonEntity> id) {
        this.id = id;
    }

    private Collection<CarDetailEntity> detail;

    @ManyToMany
    public Collection<CarDetailEntity> getDetail() {
        return detail;
    }

    public void setDetail(Collection<CarDetailEntity> detail) {
        this.detail = detail;
    }
}
